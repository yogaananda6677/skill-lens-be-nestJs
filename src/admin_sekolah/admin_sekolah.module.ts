...
import { MataPelajaran } from 'src/mata_pelajaran/entities/mata_pelajaran.entity';
import { NilaiSiswa } from 'src/nilai_siswa/entities/nilai_siswa.entity';

@Module({
  imports: [
    TypeOrmModule.forFeature([User, Guru, Sekolah, Jurusan, Siswa, MataPelajaran, NilaiSiswa]),
    SiswaModule,
    NilaiSiswaModule,
    MataPelajaranModule,
  ],
